...
export const sykmeldingApen = (mottatt: string = formatISO(sub(new Date(), { days: 2 })), id: string = 'APEN') => {
    ...
    return {
        ...
        sykmeldingsperioder: [
            ...
            {
                fom: addDays(mottatt, 6),
                tom: addDays(mottatt, 11),
                type: 'GRADERT',
                gradert: {
                    grad: 20,
                    reisetilskudd: false,
        ...
        behandletTidspunkt: addDays(mottatt, 10),
        behandler: {
            fornavn: 'Fornavn',
            mellomnavn: null,
            etternavn: 'Etternavn',
