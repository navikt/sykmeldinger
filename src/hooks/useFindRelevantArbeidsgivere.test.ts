...
describe('useFindRelevantArbeidsgivere', () => {
    ...
    it('should ignore previous SENDT sykmelding when days between relevant sykmelding fom', async () => {
        const sykmeldinger: SykmeldingFragment[] = [
            createSykmelding({
                id: 'id-1',
                sykmeldingStatus: {
    ...
    describe('filter duplicate arbeidsgivere', () => {
        ...
        it('should find unique arbeidsgivere in previous SENDT sykmeldinger whene duplicate arbeidsgivere and kant i kant', async () => {
            const sykmeldinger: SykmeldingFragment[] = [
                // sykmeldingsperiod kant i kant
                createSykmelding({
                    id: 'id-1',
