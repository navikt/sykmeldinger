...
import {
    ...
    BrukerinformasjonQueryVariables,
} from 'queries'

function useBrukerInformasjonById(sykmeldingId: string): QueryResult<BrukerinformasjonQuery, BrukerinformasjonQueryVariables> {
