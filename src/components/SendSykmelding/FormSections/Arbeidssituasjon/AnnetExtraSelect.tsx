...
const initialOptions = ['Student', 'Konkurs', 'Lærling', 'Flere arbeidsgivere']
        ...
        case 'Lærling':
            return (
                <Alert variant="warning" className="mt-4">
                    ...
                    <BodyShort className="font-bold">{`Du må endre valget ditt over fra "Annet" til "Arbeidstaker".`}</BodyShort>
                </Alert>
            )
        default:
            return null
