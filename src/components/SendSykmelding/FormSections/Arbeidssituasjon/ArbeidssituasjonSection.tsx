...
import AnsattArbeidsgiverSection from './Arbeidsgiver/AnsattArbeidsgiverSection'
    ...
    return (
        <SectionWrapper title="Din arbeidssituasjon">
            ...
            {shouldShowArbeidsgiverOrgnummer && (
                <AnsattArbeidsgiverSection sykmelding={sykmelding} arbeidsgivere={brukerinformasjon.arbeidsgivere} />
            )}
