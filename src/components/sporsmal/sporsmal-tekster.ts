const SporsmalTekster: any = {
    nb: {
        ...
        'opplysningeneErFeil.feilmelding': 'Du må oppgi hvilke opplysninger som ikke er riktige',
        'opplysningeneErFeil.periode': 'Periode',
        ...
        'sykmeldtFra.ingenting-passer': 'Jeg finner ingenting som passer for meg',
        'sykmeldtFra.arbeidsgiver.bekreft.tittel': 'Er det %ARBEIDSGIVER% som skal følge deg opp på jobben når du er syk?',
        'sykmeldtFra.arbeidsgiver.bekreft.feilmelding': 'Du må svare på om det er %ARBEIDSGIVER% som skal følge deg opp på jobben når du er syk',
        'sykmeldtFra.arbeidsgiver.bekreft.ja': 'Vi sender sykmeldingen til %ARBEIDSGIVER%, som finner den ved å logge inn på nav.no.',
        'sykmeldtFra.arbeidsgiver.bekreft.nei': 'Siden du sier det er feil, ber vi arbeidsgiveren din om å gi oss riktig navn.',
        'knapp.submit': 'SEND SYKMELDINGEN',
