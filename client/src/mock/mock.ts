...
mock.post(`${process.env.REACT_APP_SYFOREST_ROOT}/sykmeldinger/NY/actions/erUtenforVentetid`, { erUtenforVentetid: true });
...
mock.post(`${process.env.REACT_APP_SYFOREST_ROOT}/sykmeldinger/BEKREFTET/actions/erUtenforVentetid`, { erUtenforVentetid: true });
...
mock.post(`${process.env.REACT_APP_SYFOREST_ROOT}/sykmeldinger/SENDT/actions/erUtenforVentetid`, { erUtenforVentetid: true });
...
mock.post(`${process.env.REACT_APP_SYFOREST_ROOT}/sykmeldinger/AVVIST/actions/erUtenforVentetid`, { erUtenforVentetid: true });
...
mock.post(`${process.env.REACT_APP_SYFOREST_ROOT}/sykmeldinger/AVBRUTT/actions/erUtenforVentetid`, { erUtenforVentetid: true });
